        ...
        <div class="m-portlet">
            ...
            <div class="m-portlet__body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#m_tabs_1_1">
                            <i class="flaticon-interface-5"></i> Active
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <i class="flaticon-time-2 m--font-success"></i> Dropdown
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Action</a>
                            <a class="dropdown-item" data-toggle="tab" href="#m_tabs_1_2">Another action</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                            <i class="flaticon-placeholder-2"></i> Link 1
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_3">
                            <i class="flaticon-lock m--font-danger"></i> Link 2
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" data-toggle="tab" href="#m_tabs_1_4">
                            <i class="flaticon-share"></i> Disabled
                        </a>
                    </li>
                </ul>                    
