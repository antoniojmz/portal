...
// "Demo3" demo configs
include_once __DIR__ . "/config/demos/demo3/demo.php";
include_once __DIR__ . "/config/demos/demo3/layout.php";
include_once __DIR__ . "/config/demos/demo3/pages.php";
include_once __DIR__ . "/config/demos/demo3/menu.php";

// "Demo4" demo configs
include_once __DIR__ . "/config/demos/demo4/demo.php";
include_once __DIR__ . "/config/demos/demo4/layout.php";
include_once __DIR__ . "/config/demos/demo4/pages.php";
include_once __DIR__ . "/config/demos/demo4/menu.php";