                        ...
                        <div class="m-widget4 m-widget4--chart-bottom" style="min-height: 480px">
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img alt="" src="{{ asset('theme/dist/html/demo3/assets/app/media/img/client-logos/logo3.png') }}"/>
                                </div>
                            ...
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img alt="" src="{{ asset('theme/dist/html/demo3/assets/app/media/img/client-logos/logo1.png') }}"/>                                        
                                </div>
                                <div class="m-widget4__info">
                                    <span class="m-widget4__title">
                                        FlyThemes
                            ...
                            <div class="m-widget4__item">
                                <div class="m-widget4__img m-widget4__img--logo">
                                    <img alt="" src="{{ asset('theme/dist/html/demo3/assets/app/media/img/client-logos/logo4.png') }}"/>
                                </div>
                                <div class="m-widget4__info">
                                    <span class="m-widget4__title">
                                        Starbucks
                        ...
                        <div class="m-widget7 m-widget7--skin-dark">
                            ...
                            <div class="m-widget7__user">
                                <div class="m-widget7__user-img">
                                    <img class="m-widget7__img" alt="" src="{{ asset('theme/dist/html/demo3/assets/app/media/img/users/100_5.jpg') }}"/>  
                                </div>
                    ...
                    <div class="m-portlet__body">
                        <div class="m-widget19">
                            <div class="m-widget19__pic m-portlet-fit--top m-portlet-fit--sides" style="min-height-: 286px">
                                <img alt="" src="{{ asset('theme/dist/html/demo3/assets/app/media/img/blog/blog1.jpg') }}"/>
                            ...
                            <div class="m-widget19__content">
                                <div class="m-widget19__header">
                                    <div class="m-widget19__user-img">
                                        <img class="m-widget19__img" alt="" src="{{ asset('theme/dist/html/demo3/assets/app/media/img/users/user1.jpg') }}"/>
                                    </div>
